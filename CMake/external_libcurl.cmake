if(BUILD_LIBCURL)
    ...
    ExternalProject_Add(
        libcurl
        PREFIX libcurl-prefix

        GIT_REPOSITORY "https://github.com/curl/curl.git"
        GIT_TAG "curl-7_75_0" # commit 2f33be817cbce6ad7a36f27dd7ada9219f13584c
        GIT_SHALLOW true
    ...
    target_include_directories(curl INTERFACE $<BUILD_INTERFACE:${CMAKE_CURRENT_BINARY_DIR}/libcurl_install/include>)
        
    target_link_libraries(curl INTERFACE debug ${CMAKE_CURRENT_BINARY_DIR}/libcurl_install/lib/${CURL_DEBUG_TARGET_NAME}${CMAKE_STATIC_LIBRARY_SUFFIX})
    target_link_libraries(curl INTERFACE optimized ${CMAKE_CURRENT_BINARY_DIR}/libcurl_install/lib/${CURL_RELEASE_TARGET_NAME}${CMAKE_STATIC_LIBRARY_SUFFIX})
