...
namespace librealsense
{
    ...
    double ds5_device::get_device_time_ms()
    {
        ...
        // LIPS HACK: follow the same Raspberry Pi workaround to use system-time to avoid global-time overhead
        // such hw monitor command causes overhead and depth streaming lag problem when people waving hands before camera
#if defined(RASPBERRY_PI) || defined(DISABLE_GLOBAL_TIME)
